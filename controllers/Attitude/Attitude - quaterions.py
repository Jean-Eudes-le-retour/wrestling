...
from ahrs.filters import Mahony, Madgwick, AngularRate, Tilt
...
class Alice (Robot):
    def __init__(self):
        ...
        self.accelerometer.enable(self.time_step_ms)
    ...
    def run(self):
        ...
        while self.step(self.time_step_ms) != -1:
            ...
            Q_tilt = self.tilt.estimate(acc)
            print('-' * 20)
            print('IMU :')
            print(Q_imu)
            print('Mahony :')
            print(Q_mahony)
            print('Difference with IMU :', self.angle_difference(Q_imu, Q_mahony))
            print('Madgwick :')
            print(Q_madgwick)
            print('Difference with IMU :', self.angle_difference(Q_imu, Q_madgwick))
            print('Angular Rate :')
            print(Q_angular_rate)
            print('Difference with IMU :', self.angle_difference(Q_imu, Q_angular_rate))
            print('Manual Angular Rate :')
            print(Q_manual_angular_rate)
            print('Difference with IMU :', self.angle_difference(Q_imu, Q_manual_angular_rate))
            print('Tilt :')
            print(Q_tilt)
            print('Difference with IMU :', self.angle_difference(Q_imu, Q_tilt))
